...
//     <a-assets>
//       {assets.map(({ id, src }) => (
//         <a-asset-items key={id} id={id} src={src}></a-asset-items> // Use a-asset-items, not a-asset-item
//       ))}
//     </a-assets>
//   );
// };
...
// const robot_list = [
//   { robotId: "robot1", robot_model: "agilex_piper" },
//   { robotId: "robot2", robot_model: "jaka_zu_5" },
//   { robotId: "robot3", robot_model: "myCobot280" },
// ];
